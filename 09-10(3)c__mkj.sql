...
--가상컬럼명을 설정
--제품테이블에서 제조업제의 중복데이터를 제거하고 검색하시오.(단 제조업체를 대표업체로 가상컬럼명 변경)
...
--제품테이블에서 제품명, 단가를 검색하되, 단과에 500원을 더해서 조정 단가라느 가상컬럼명으로 출력하시오.
...
--제품테이블에서 나이가 20세이상  30세 이하인 고객의 고객이름, 나이, 직업을 출력하시오.
select 고객이름, 나이, 직업
     from 고객
